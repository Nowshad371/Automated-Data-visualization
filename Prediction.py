...
Main_set = pd.read_csv('data_store/item_details/orders.csv')
...
record_track = 'data_store/Accuracy/Accuarcy_record.csv'
file_exists = exists(record_track)
#files that combine current and previous data
storing_df = 'data_store/retail_store/df_order.csv'
if (file_exists):
    ...
    new_df = 'data_store/retail_store/df_order_0' + str(index_number) + ".csv"
    #previous file
    ...
    index = model_num
    #new file
    new_df = 'data_store/retail_store/df_order_0' + str(index) + ".csv"
...
item_df =pd.read_csv(r'data_store/item_details/items.csv', sep='\t')
...
record = 'data_store/Accuracy/Accuarcy_record.csv'
...
Test_df = pd.read_csv('data_store/solution/submission.csv',sep='\t')
...
soluton_df.to_csv('data_store/solution/soluton_df.csv', index=False)
